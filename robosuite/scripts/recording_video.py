...
def playback_trajectory(env, ep_dir, camera):
    ...
    # create a video writer with imageio
    writer = imageio.get_writer('./video/'+ep_dir.split('/')[-1]+'_video.mp4', fps=20)
...
if __name__ == "__main__":
    ...
    tmp_directory = "./data/{}".format(str(time.time()).replace(".", "_"))
...
#        from robosuite.devices import SpaceMouse
    ...
    while True:
        ...
        playback_trajectory(env_playback, data_directory, args.camera)      
